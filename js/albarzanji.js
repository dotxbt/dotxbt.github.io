const Albarzanji = async () => {
  ...
  parentEl.classList =
    "flex flex-col items-start w-full  max-w-4xl text-slate-800";
...
const SectionCard = (parentEl, title, partTitle, bismillahTitle, data) => {
  ...
  headerTitle.classList = `text-center p-4 text-3xl w-full leading-[2.4] bg-amber-200 `;
  headerTitle.innerHTML = partTitle;
  parentEl.appendChild(headerTitle);

  const bismillah = document.createElement("p");
  bismillah.classList = `text-center p-4 text-[24pt] sm:text-[32pt] w-full leading-[1.8] bg-green-200`;
  ...
  data.forEach((e, i) => {
    if (`${e}`.includes("#")) {
      ...
      txt.classList = `text-end p-4 flex-1 text-3xl w-full leading-[2.4] `;
      ...
      txt2.classList = `text-start p-4 flex-1 text-3xl w-full leading-[2.4] `;
      ...
      txtMobile.classList = `text-end p-4 flex-1 text-3xl w-full leading-[2.4] `;
      ...
      separatorMobile.classList = "-my-6 flex flex-row items-center w-full";
      ...
      txt2Mobile.classList = `text-start p-4 flex-1 text-3xl w-full leading-[2.4] `;
      txt2Mobile.innerHTML = dataItemMobile[1];
      containerItemMobile.appendChild(txt2Mobile);
      parentEl.appendChild(containerItemMobile);
    } else {
      const txt = document.createElement("p");
      txt.classList = `text-end p-4 text-3xl w-full leading-[2.4] ${
        i % 2 === 0 ? "bg-slate-100" : "bg-slate-200"
      }`;
      txt.innerHTML = e;
...
const Container = (children) => {
  ...
  appContainer.classList =
    "flex flex-1 flex-col bg-slate-600 items-center line-space";
